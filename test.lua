...
xpcall(function()
	...
	Shared:Notify("INITIALIZING API", "Beginning initialization of API")
	...
	Shared:Notify("DOWNLOADING LATEST CLASSES", "This could take a while", 4)
	...
	Shared:Notify("CLASSES DOWNLOADED", "Beginning next step", 2)
